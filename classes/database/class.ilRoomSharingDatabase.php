...
class ilRoomSharingDatabase
{
	...
	{
		return $this->ilRoomSharingDatabaseBooking->insertBooking($a_booking_attr_values,
	...
	{
		return $this->ilRoomSharingDatabaseBooking->insertBookingRecurrence($a_booking_attr_values,
				$a_booking_values, $a_booking_participants);
	}
	...
	{
		return $this->ilRoomSharingDatabaseBooking->getBookingIdsForRoomInDateimeRanges($a_room_id,
				$a_datetimes_from, $a_datetimes_to);
	}
	...
	{
		return $this->ilRoomSharingDatabaseBooking->updateBooking($a_booking_id, $a_booking_attr_values,
	...
	public function getBookingIdForRoomInDateTimeRange($a_date_from, $a_date_to, $a_room_id,
		$a_booking_id)
	{
		return $this->ilRoomSharingDatabaseBooking->getBookingIdForRoomInDateTimeRange($a_date_from,
	...
	{
		$this->ilRoomSharingDatabaseCalender->insertBookingAppointment($insertedId, $a_booking_values,
			$from, $to);
	}
	...
	{
		return $this->ilRoomSharingDatabasePrivileges->getAssignedClassesForUser($a_user_id,
				$a_user_role_ids);
	}
	...
	{
		$this->ilRoomSharingDatabasePrivileges->setPrivilegesForClass($a_class_id, $a_privileges,
			$a_no_privileges);
	}
	...
	{
		return $this->ilRoomSharingDatabasePrivileges->insertClass($a_name, $a_description, $a_role_id,
				$a_priority, $a_copy_class_id);
	}
	...
	{
		$this->ilRoomSharingDatabasePrivileges->updateClass($a_class_id, $a_name, $a_description,
			$a_role_id, $a_priority);
	}
	...
	{
		return $this->ilRoomSharingDatabaseRoom->getRoomsBookedInDateTimeRange($a_datetimes_from,
	...
	{
		return $this->ilRoomSharingDatabaseRoom->insertRoom($a_name, $a_type, $a_min_alloc, $a_max_alloc,
	...
	public function updateRoomProperties($a_id, $a_name, $a_type, $a_min_alloc, $a_max_alloc,
		$a_file_id, $a_building_id)
	{
		return $this->ilRoomSharingDatabaseRoom->updateRoomProperties($a_id, $a_name, $a_type,
				$a_min_alloc, $a_max_alloc, $a_file_id, $a_building_id);
	}
	...
	{
		$this->ilRoomSharingDatabaseRoomAttribute->insertAttributeForRoom($a_room_id, $a_attribute_id,
			$a_amount);
	}
	...
	{
		$this->ilRoomSharingDatabaseRoomAttribute->renameRoomAttribute($a_attribute_id,
			$a_changed_attribute_name);
	}
	...
	{
		$this->ilRoomSharingDatabaseBookingAttribute->insertBookingAttributeAssign($a_insertedId,
			$a_booking_attr_key, $a_booking_attr_value);
	}
	...
	public function updateBookingAttributeAssign($a_booking_id, $a_booking_attr_key,
		$a_booking_attr_value)
	{
		$this->ilRoomSharingDatabaseBookingAttribute->updateBookingAttributeAssign($a_booking_id,
			$a_booking_attr_key, $a_booking_attr_value);
	}
	...
	{
		$this->ilRoomSharingDatabaseBookingAttribute->updateDelBookingAttributeAssign($a_booking_id,
			$a_booking_attr_key);
	}
	...
	{
		$this->ilRoomSharingDatabaseBookingAttribute->renameBookingAttribute($a_attribute_id,
			$a_changed_attribute_name);
	}
	...
	{
		$this->ilRoomSharingDatabaseParticipants->insertBookingParticipants($a_insertedId,
			$a_booking_participants);
	}
	...
	public function updateBookingParticipants($a_booking_id, $a_booking_participants,
		$a_old_booking_participants)
	{
		$this->ilRoomSharingDatabaseParticipants->updateBookingParticipants($a_booking_id,
			$a_booking_participants, $a_old_booking_participants);
	}
