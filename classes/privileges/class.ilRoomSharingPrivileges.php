...
class ilRoomSharingPrivileges {
	...
	public function getPrivilegesMatrix() {
		...
		if (ilRoomSharingNumericUtils::isPositiveNumber(count($this->getClasses()))) {
			...
			$privilegesMatrix[] = $this->addPrivilege("accessAppointments", "rep_robj_xrs_access_appointments", "rep_robj_xrs_access_appointments_description");
			$privilegesMatrix[] = $this->addPrivilege("accessSearch", "rep_robj_xrs_access_search", "rep_robj_xrs_access_search_description");
			$privilegesMatrix[] = $this->addPrivilege("addOwnBookings", "rep_robj_xrs_create_edit_delete", "rep_robj_xrs_create_edit_delete_description");
			$privilegesMatrix[] = $this->addPrivilege("addParticipants", "rep_robj_xrs_add_participant", "rep_robj_xrs_add_participant_description");
			$privilegesMatrix[] = $this->addPrivilege("addSequenceBookings", "rep_robj_xrs_sequence_bookings", "rep_robj_xrs_sequence_bookings_addable");
			$privilegesMatrix[] = $this->addPrivilege("addUnlimitedBookings", "rep_robj_xrs_add_unlimited_bookings", "rep_robj_xrs_add_unlimited_bookings_description");
			$privilegesMatrix[] = $this->addPrivilege("seeNonPublicBookingInformation", "rep_robj_xrs_see_non_public_booking_information", "rep_robj_xrs_see_non_public_booking_information_description");
			$privilegesMatrix[] = $this->addPrivilege("accessImport", "rep_robj_xrs_import_bookings_from_external_file", "rep_robj_xrs_import_bookings_from_external_file_description");
			$privilegesMatrix[] = $this->addPrivilege("adminBookingAttributes", "rep_robj_xrs_create_edit_delete_booking_attributes", "rep_robj_xrs_create_edit_delete_booking_attributes_description");
			$privilegesMatrix[] = $this->addPrivilege("cancelBookingLowerPriority", "rep_robj_xrs_cancel_lower_priority", "rep_robj_xrs_cancel_lower_priority_description");
			$privilegesMatrix[] = $this->addPrivilege("notificationSettings", "rep_robj_xrs_notification_tunable", "rep_robj_xrs_notification_tunable_description");
			$privilegesMatrix[] = $this->addSelectMultipleCheckbox("bookings", array(
					"accessAppointments",
					"accessSearch",
					"addParticipants",
					"accessImport",
					"addOwnBookings",
					"addSequenceBookings",
					"addUnlimitedBookings",
					"adminBookingAttributes",
					"cancelBookingLowerPriority",
					"notificationSettings",
					"seeNonPublicBookingInformation"
				));

			// ### Rooms ###
			$privilegesMatrix[] = $this->addNewSection("rep_robj_xrs_rooms", "rep_robj_xrs_rooms_privileges_description");
			$privilegesMatrix[] = $this->addPrivilege("accessRooms", "rep_robj_xrs_access_rooms", "rep_robj_xrs_access_rooms_description");
			$privilegesMatrix[] = $this->addPrivilege("seeBookingsOfRooms", "rep_robj_xrs_see_booking_of_rooms", "rep_robj_xrs_see_booking_of_rooms_description");
			$privilegesMatrix[] = $this->addPrivilege("addRooms", "rep_robj_xrs_create", "rep_robj_xrs_create_rooms_description");
			$privilegesMatrix[] = $this->addPrivilege("editRooms", "rep_robj_xrs_edit", "rep_robj_xrs_create_edit_rooms_description");
			$privilegesMatrix[] = $this->addPrivilege("deleteRooms", "rep_robj_xrs_delete", "rep_robj_xrs_create_delete_rooms_description");
			$privilegesMatrix[] = $this->addPrivilege("adminRoomAttributes", "rep_robj_xrs_create_edit_delete_room_attributes", "rep_robj_xrs_create_edit_delete_room_attributes_description");
			$privilegesMatrix[] = $this->addSelectMultipleCheckbox("rooms", array(
					"accessRooms",
					"seeBookingsOfRooms",
					"addRooms",
					"editRooms",
			...
			// ### Floorplans ###
			$privilegesMatrix[] = $this->addNewSection("rep_robj_xrs_floorplans", "rep_robj_xrs_floorplans_privileges_description");
			$privilegesMatrix[] = $this->addPrivilege("accessFloorplans", "rep_robj_xrs_access_floorplans", "rep_robj_xrs_access_floorplans_description");
			$privilegesMatrix[] = $this->addPrivilege("addFloorplans", "rep_robj_xrs_create", "rep_robj_xrs_create_floorplans_description");
			$privilegesMatrix[] = $this->addPrivilege("editFloorplans", "rep_robj_xrs_edit", "rep_robj_xrs_edit_floorplans_description");
			$privilegesMatrix[] = $this->addPrivilege("deleteFloorplans", "rep_robj_xrs_delete", "rep_robj_xrs_delete_floorplans_description");
			$privilegesMatrix[] = $this->addSelectMultipleCheckbox("floorplans", array(
					"accessFloorplans",
					"addFloorplans",
					"editFloorplans",
					"deleteFloorplans"
			...
			// ### Privileges ###
			$privilegesMatrix[] = $this->addNewSection("rep_robj_xrs_general_privileges", "rep_robj_xrs_general_privileges_description");
			$privilegesMatrix[] = $this->addPrivilege("accessSettings", "rep_robj_xrs_access_settings", "rep_robj_xrs_access_settings_description");
			$privilegesMatrix[] = $this->addPrivilege("accessPrivileges", "rep_robj_xrs_access_privileges", "rep_robj_xrs_access_privileges_description");
			$privilegesMatrix[] = $this->addPrivilege("addClass", "rep_robj_xrs_create_class", "rep_robj_xrs_create_class_description");
			$privilegesMatrix[] = $this->addPrivilege("editClass", "rep_robj_xrs_edit_class", "rep_robj_xrs_edit_class_description");
			$privilegesMatrix[] = $this->addPrivilege("deleteClass", "rep_robj_xrs_delete_class", "rep_robj_xrs_delete_class_description");
			$privilegesMatrix[] = $this->addPrivilege("editPrivileges", "rep_robj_xrs_edit_privileges", "rep_robj_xrs_edit_privileges_description");
			$privilegesMatrix[] = $this->addPrivilege("lockPrivileges", "rep_robj_xrs_lock_privileges", "rep_robj_xrs_lock_privileges_description");
			$privilegesMatrix[] = $this->addSelectMultipleCheckbox("privileges", array(
					"accessSettings",
					"accessPrivileges",
					"addClass",
					"editClass",
	...
	public function addClass($a_classData) {
		$insertedID = $this->ilRoomsharingDatabase->insertClass($a_classData['name'], $a_classData['description'], $a_classData['role_id'], $a_classData['priority'], $a_classData['copied_class_privileges']);
	...
	private function addNewSection($a_section_title_lng_key, $a_section_description_lng_key = NULL) {
		return array(
			"show_section_info" => 1,
			"section" => array(
				"title" => $this->lng->txt($a_section_title_lng_key),
