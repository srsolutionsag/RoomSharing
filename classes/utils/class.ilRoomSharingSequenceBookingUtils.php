...
class ilRoomSharingSequenceBookingUtils {
	 ...
	 */
	public static function generateDailyDaysWithEndDate($a_startday, $a_untilday, $a_every_x_days, $a_time_from = NULL, $a_time_to = NULL, $a_day_difference = NULL) {
	 ...
	 * @return array Generated Date(times)
	 */
	public static function generateDailyDaysWithCount($a_startday, $a_count, $a_every_x_days, $a_time_from = NULL, $a_time_to = NULL, $a_day_difference = NULL) {
		if (ilRoomSharingNumericUtils::isPositiveNumber($a_day_difference, true)) {
			$day_difference_to_end_day = $a_day_difference;
		} else {
			$day_difference_to_end_day = 0;
	 ...
	 * @return array Generated Date(times)
	 */
	public static function generateWeeklyDaysWithEndDate($a_startday, $a_enddate, $a_weekdays, $a_every_x_weeks, $a_time_from = NULL, $a_time_to = NULL, $a_day_difference = NULL) {
		if (ilRoomSharingNumericUtils::isPositiveNumber($a_day_difference, true)) {
			$day_difference_to_end_day = $a_day_difference;
		} else {
			$day_difference_to_end_day = 0;
		...
		$i = 0;
		while (true) {
			$days['from'] = self::getFollowingWeekdaysByWeekdayNames($startday, $a_weekdays, $time_format, $days['from']);

			$startday = date('Y-m-d' . $time_format, strtotime($startday . ' + ' . $a_every_x_weeks . ' week'));
	 ...
	 * @return array Generated Date(times)
	 */
	public static function generateWeeklyDaysWithCount($a_startday, $a_count, $a_weekdays, $a_every_x_weeks, $a_time_from = NULL, $a_time_to = NULL, $a_day_difference = NULL) {
		if (ilRoomSharingNumericUtils::isPositiveNumber($a_day_difference, true)) {
			$day_difference_to_end_day = $a_day_difference;
		} else {
			$day_difference_to_end_day = 0;
	 ...
	 * @return array Generated Date(times)
	 */
	public static function generateMonthlyDaysAtVariableDateWithEndDate($a_startday, $a_variable_number, $a_each_day, $a_enddate, $a_every_x_months, $a_time_from = NULL, $a_time_to = NULL, $a_day_difference = NULL) {
		if (ilRoomSharingNumericUtils::isPositiveNumber($a_day_difference, true)) {
			$day_difference_to_end_day = $a_day_difference;
		} else {
			$day_difference_to_end_day = 0;
		...
		while (true) {
			...
			$days['from'][] = date('Y-m-d' . $time_format, strtotime($variable_name . " " . $each_day_name . " of "
					. $monthname_with_year_of_startday));

			$days['from'] = self::convertSelectedDayOfMonthWithoutStrtotime($days['from'], $each_day_name, $variable_name, $monthname_with_year_of_startday, $time);
	 ...
	 * @return array Generated Date(times)
	 */
	public static function generateMonthlyDaysAtVariableDateWithCount($a_startday, $a_variable_number, $a_each_day, $a_count, $a_every_x_months, $a_time_from = NULL, $a_time_to = NULL, $a_day_difference = NULL) {
		if (ilRoomSharingNumericUtils::isPositiveNumber($a_day_difference, true)) {
			$day_difference_to_end_day = $a_day_difference;
		} else {
			$day_difference_to_end_day = 0;
	 ...
	 * @return array Generated Date(times)
	 */
	public static function generateMonthlyDaysAtFixedDateWithEndDate($a_startday, $a_monthday, $a_enddate, $a_every_x_months, $a_time_from = NULL, $a_time_to = NULL, $a_day_difference = NULL) {
	 ...
	 * @return array Generated Date(times)
	 */
	public static function getMonthlyFilteredData($a_date, $a_repeat_type, $a_repeat_amount, $a_repeat_until, $a_start_type, $a_monthday, $a_weekday_1, $a_weekday_2, $a_time_from = NULL, $a_time_to = NULL, $a_day_difference = NULL) {
		$days = array();
		if ($a_start_type == "weekday") {
			if ($a_repeat_type == "max_date") {
				$days = self::generateMonthlyDaysAtVariableDateWithEndDate($a_date, $a_weekday_1, $a_weekday_2, $a_repeat_until, $a_repeat_amount, $a_time_from, $a_time_to, $a_day_difference);
			} elseif ($a_repeat_type == "max_amount") {
				$days = self::generateMonthlyDaysAtVariableDateWithCount($a_date, $a_weekday_1, $a_weekday_2, $a_repeat_until, $a_repeat_amount, $a_time_from, $a_time_to, $a_day_difference);
			}
		} elseif ($a_start_type == "monthday") {
			if ($a_repeat_type == "max_date") {
				$days = self::generateMonthlyDaysAtFixedDateWithEndDate($a_date, $a_monthday, $a_repeat_until, $a_repeat_amount, $a_time_from, $a_time_to, $a_day_difference);
			} elseif ($a_repeat_type == "max_amount") {
				$days = self::generateMonthlyDaysAtFixedDateWithCount($a_date, $a_monthday, $a_repeat_until, $a_repeat_amount, $a_time_from, $a_time_to, $a_day_difference);
			}
		}
	 ...
	 * @return array Generated Date(times)
	 */
	public static function getWeeklyFilteredData($a_date, $a_repeat_type, $a_repeat_amount, $a_repeat_until, $a_weekdays, $a_time_from = NULL, $a_time_to = NULL, $a_day_difference = NULL) {
		if ($a_repeat_type == "max_date") {
			$a_repeat_until = date('Y-m-d', mktime(23, 59, 59, $a_repeat_until['date']['m'], $a_repeat_until['date']['d'], $a_repeat_until['date']['y']));
			$days = self::generateWeeklyDaysWithEndDate($a_date, $a_repeat_until, $a_weekdays, $a_repeat_amount, $a_time_from, $a_time_to, $a_day_difference);
		} elseif ($a_repeat_type == "max_amount") {
			$days = self::generateWeeklyDaysWithCount($a_date, $a_repeat_until, $a_weekdays, $a_repeat_amount, $a_time_from, $a_time_to, $a_day_difference);
		}
	 ...
	 * @return array Generated Date(times)
	 */
	public static function getDailyFilteredData($a_date, $a_repeat_type, $a_repeat_amount, $a_repeat_until, $a_time_from = NULL, $a_time_to = NULL, $a_day_difference = NULL) {
		if ($a_repeat_type == "max_date") {
			$a_repeat_until = date('Y-m-d', mktime(23, 59, 59, $a_repeat_until['date']['m'], $a_repeat_until['date']['d'], $a_repeat_until['date']['y']));
			$days = self::generateDailyDaysWithEndDate($a_date, $a_repeat_until, $a_repeat_amount, $a_time_from, $a_time_to, $a_day_difference);
		} elseif ($a_repeat_type == "max_amount") {
			$days = self::generateDailyDaysWithCount($a_date, $a_repeat_until, $a_repeat_amount, $a_time_from, $a_time_to, $a_day_difference);
		}
	 ...
	 */
	private static function convertSelectedDayOfMonthWithoutStrtotime($a_days, $a_each_day_name, $a_variable_name, $a_monthname_with_year, $a_time = NULL) {
		$days = $a_days;
	 ...
	 */
	private function getFollowingWeekdaysByWeekdayNames($a_startday, $a_weekday_shortnames, $a_time_format = "", $a_append_array = array()) {
